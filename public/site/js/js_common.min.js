...
(function ($, window, document, undefined) {
    ...
    Autoplay.Defaults = {autoplay: !1, autoplayTimeout: 5000, autoplayHoverPause: !1, autoplaySpeed: !1};
...
!function (e) {
    e.fn.viewbox = function (t) {
        function n(e) {
            if (!y) {
                u();
                var n = e.attr("href"), i = t.setTitle && e.attr("title") ? e.attr("title") : "";
                n ? c(n) ? (b = e, h(n, i)) : l(n) && (b = e, g(n, i)) : (b = e, g(e, i))
            }
        }

        function i(n, i) {
            var a, r, c = o("body"), l = o("content");
            n && l.width(n), i && l.height(i), m ? (a = c.width(), r = c.height()) : (m = !0, e("body").append(p), p.show(), a = c.width(), r = c.height(), p.hide(), p.fadeIn(t.openDuration)), c.css({
                "margin-left": -a / 2,
                "margin-top": -r / 2
            })
        }
        ...
        function r() {
            var e = -1;
            return b && f.each(function (t) {
                return b.is(this) ? (e = t, !1) : void 0
            }), e
        }

        function c(e) {
            return e.match(/(png|jpg|jpeg|gif)(\?.*)?$/i)
        }
        ...
        function v(t) {
            ...
            return n.appendTo(p).get(0).insertAdjacentHTML("afterbegin", '<svg><use xlink:href="' + i + '"/></svg>'), n
        }

        function g(t, n) {
            var r = e(t), c = e('<div class="viewbox-content-placeholder"></div>');
            r.before(c), m && p.trigger("viewbox.close"), a("content", ""), a("header", n), o("content").append(r), i("auto", "auto"), k.push({
                placeholder: c,
                content: r
            })
        }
        ...
        function u() {
            for (var e; k.length;) e = k.shift(), e.placeholder.before(e.content), e.placeholder.detach()
        }

        function h(n, r) {
            var c = e('<img class="viewbox-image" alt="">').attr("src", n);
            s(c) || d(!0), a("content", ""), a("header", r), i();
            var l = o("body"), v = 0, g = o("content"), u = window.setInterval(function () {
                if (!s(c) && 1e3 > v) return void v++;
                window.clearInterval(u), d(!1), e("body").append(c);
                var n = l.width() - g.width() + 2 * t.margin, i = l.height() - g.height() + 2 * t.margin,
                    o = e(window).width() - n, a = e(window).height() - i, r = c.width(), h = c.height();
                c.detach(), r > o && (h = h * o / r, r = o), h > a && (r = r * a / h, h = a), y = !0, l.animate({}, t.resizeDuration), g.animate({
                    width: r,
                    height: h
        ...
        function w(e, t) {
            if ("function" == typeof t) {
                var n, i, o = 150, a = 100, r = 300;
                e.on("touchstart", function (e) {
                    var t = e.originalEvent.changedTouches[0];
                    n = {x: t.pageX, y: t.pageY}, i = (new Date).getTime()
                }), e.on("touchend", function (e) {
                    var c = e.originalEvent.changedTouches[0], l = "none", s = (new Date).getTime() - i,
                        d = {x: c.pageX, y: c.pageY}, v = {x: d.x - n.x, y: d.y - n.y};
                    r >= s && (Math.abs(v.x) >= o && Math.abs(v.y) <= a ? l = v.x < 0 ? "left" : "right" : Math.abs(v.y) >= o && Math.abs(v.x) <= a && (l = v.y < 0 ? "up" : "down")), t.call(this, l)
                })
            }
        }

        "undefined" == typeof t && (t = {}), t = e.extend({
        ...
        var b, f = e(this), p = e(t.template), x = e(t.loader), m = !1, y = !1, k = [];
        return e("#viewbox-sprite").length || e("body").get(0).insertAdjacentHTML("afterbegin", '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="viewbox-sprite" style="display:none"><symbol id="viewbox-close-icon" viewBox="0 0 50 50"><path d="M37.304 11.282l1.414 1.414-26.022 26.02-1.414-1.413z"/><path d="M12.696 11.282l26.022 26.02-1.414 1.415-26.022-26.02z"/></symbol><symbol id="viewbox-prev-icon" viewBox="0 0 50 50"><path d="M27.3 34.7L17.6 25l9.7-9.7 1.4 1.4-8.3 8.3 8.3 8.3z"/></symbol><symbol id="viewbox-next-icon" viewBox="0 0 50 50"><path d="M22.7 34.7l-1.4-1.4 8.3-8.3-8.3-8.3 1.4-1.4 9.7 9.7z"/></symbol></svg>'), p.bind("viewbox.open", function (t, i) {
            Number.isInteger(i) && f.length ? n(f.eq(i >= 0 && i < f.length ? i : 0)) : i && i.tagName ? n(e(i)) : f.length && n(f.eq(0))
        }), p.bind("viewbox.next", function (e) {
            if (!(f.length <= 1)) {
                var t = r() + 1;
                t >= f.length && (t = 0), n(f.eq(t))
            }
        }), p.bind("viewbox.prev", function (e) {
            if (!(f.length <= 1)) {
                var t = r() - 1;
                0 > t && (t = f.length - 1), n(f.eq(t))
            }
        }), p.bind("viewbox.close", function (e) {
            m && p.fadeOut(t.closeDuration, function () {
                m = !1
            })
        }), f.filter("a").click(function () {
            return p.trigger("viewbox.open", [this]), !1
        }), o("body").click(function (e) {
            e.stopPropagation(), t.nextOnContentClick && p.trigger("viewbox.next")
        }), t.closeButton && v("close").click(function (e) {
            e.stopPropagation(), p.trigger("viewbox.close")
        }), t.navButtons && f.length > 1 && (v("next").click(function (e) {
            e.stopPropagation(), p.trigger("viewbox.next")
        }), v("prev").click(function (e) {
            e.stopPropagation(), p.trigger("viewbox.prev")
        })), t.closeOnSideClick && p.click(function () {
            p.trigger("viewbox.close")
        }), t.useGestures && "ontouchstart" in document.documentElement && w(p, function (e) {
            switch (e) {
                case "left":
                    p.trigger("viewbox.next");
                    break;
                case "right":
                    p.trigger("viewbox.prev")
            }
        }), p
    }
}(jQuery);
$(function () {
    var html = $('html, body'), navContainer = $('.nav-container'), navToggle = $('.nav-toggle'),
...
function render_size() {
    var h_6654 = $('.h_6654 img').width();
    $('.h_6654 img').height(Math.ceil(0.6654 * parseInt(h_6654)))
};
...
$(function () {
    $(".slider_main").owlCarousel({
        items: 1,
        responsive: {1200: {item: 1,}, 982: {items: 1,}, 768: {items: 1,}, 480: {items: 1,}, 0: {items: 1,}},
        rewind: !1,
        autoplay: !0,
    ...
    $(".slide4").owlCarousel({
        items: 4,
        responsive: {1200: {item: 4,}, 982: {items: 3,}, 768: {items: 2,}, 480: {items: 2,}, 0: {items: 1,}},
        rewind: !1,
        autoplay: !0,
        autoplayHoverPause: !0,
        autoplayTimeout: 5000,
...
$(document).ready(function () {
    $(".buttonClick").click(function () {
        $(".menuFooter ul").slideToggle("slow")
    })
});
$(function () {
    $(".slider_main").owlCarousel({
...
$(document).ready(function () {
    $(".viewbox-body .close").click(function () {
...
function print(id) {
    ...
    $.ajax({
        url: url + 'products/printItem', data: {id: id}, type: "POST", dataType: "json", success: function (res) {
            PrintMachine(res.template)
        }
    })
}

function PrintMachine(template, title = '') {
