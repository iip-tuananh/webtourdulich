    ...
    <div class="col-sm-4">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label>Phân loại sản phẩm <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Phân loại sản phẩm để tạo các thuộc tính (màu sắc, kích cỡ, ...)"></i></label>
...
{{--        </div>--}}
        ...
        <div class="form-group text-center">
            <div class="main-img-preview">
                <label for="">Ảnh dùng để tạo thiết kế</label>
                ...
                <div class="input-group-btn" style="margin: 0 auto">
                    <div class="fileUpload fake-shadow cursor-pointer">
                        <label class="mb-0" for="<% form.image.element_id %>">
                            <i class="glyphicon glyphicon-upload"></i> Chọn ảnh (mặt trước)
                        </label>
            ...
            <div class="main-img-preview">
                <p class="help-block-img">* Ảnh định dạng: jpg, png không quá 2MB.</p>
                <p class="help-block-img">Ảnh mặt sau (500x500px)</p>
                ...
                <div class="input-group-btn" style="margin: 0 auto">
                    <div class="fileUpload fake-shadow cursor-pointer">
                        <label class="mb-0" for="<% form.image_back.element_id %>">
                            <i class="glyphicon glyphicon-upload"></i> Chọn ảnh (mặt sau)
                        </label>
