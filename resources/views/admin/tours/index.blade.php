...
@section('buttons')
    @if(Auth::user()->type == App\Model\Common\User::QUAN_TRI_VIEN || Auth::user()->type == App\Model\Common\User::SUPER_ADMIN)
        <a href="{{ route('Tour.create') }}" class="btn btn-outline-success btn-sm" class="btn btn-info"><i
...
@section('script')
    ...
    <script>
        let datatable = new DATATABLE('table-list', {
            ...
            search_columns: [
                {data: 'name', search_type: "text", placeholder: "Tên tour"},
                {
        ...
        app.controller('Tour', function ($scope, $rootScope, $http) {
            ...
            $('#table-list').on('click', '.add-category-special', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "/admin/tours/" + $scope.data.id + "/getData",
                    headers: {
            ...
            $scope.submit = function () {
                let url = "/admin/tours/add-category-special";
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        category_special_ids: $scope.tour.category_special_ids
                    },
                    success: function (response) {
                        if (response.success) {
