<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview  {{ request()->is('common/tours') || request()->is('uptek/tours*') || request()->is('admin/tours') || request()->is('admin/tours*') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('Tour.index') }}" class="nav-link {{ Request::routeIs('Tour.create') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh sách tour</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('Tour.create') }}" class="nav-link {{ Request::routeIs('Tour.create') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Thêm mới tour</p>
                        </a>
                    </li>
