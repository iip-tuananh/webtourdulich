...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'tours'], function () {
        Route::get('/', 'Admin\TourController@index')->name('Tour.index');
        Route::get('/create', 'Admin\TourController@create')->name('Tour.create')->middleware('checkPermission:Thêm hàng hóa');
        Route::post('/', 'Admin\TourController@store')->name('Tour.store')->middleware('checkPermission:Thêm hàng hóa');
        Route::post('/{id}/update', 'Admin\TourController@update')->name('Tour.update')->middleware('checkPermission:Sửa hàng hóa');
        Route::get('/{id}/edit', 'Admin\TourController@edit')->name('Tour.edit')->middleware('checkPermission:Sửa hàng hóa');
        Route::get('/{id}/delete', 'Admin\TourController@delete')->name('Tour.delete')->middleware('checkPermission:Xóa hàng hóa');
        Route::get('/searchData', 'Admin\TourController@searchData')->name('Tour.searchData');
        Route::get('/filterDataForBill', 'Admin\TourController@filterDataForBill')->name('Tour.filterDataForBill');
        Route::get('/{id}/getData', 'Admin\TourController@getData')->name('Tour.getData');
        Route::get('/exportExcel','Admin\TourController@exportExcel')->name('Tour.exportExcel')->middleware('checkPermission:Xuất excel sản phẩm');
        Route::get('/exportPDF','Admin\TourController@exportPDF')->name('Tour.exportPDF')->middleware('checkPermission:Xuất pdf sản phẩm');
        Route::post('/add-category-special', 'Admin\TourController@addToCategorySpecial')->name('Product.add.category.special');

        Route::get('/act-delete', 'Admin\TourController@actDelete')->name('Tour.delete.multi');
        Route::post('/{id}/deleteFile', 'Admin\TourController@deleteFile')->name('Tour.deleteFile');
    });
    ...
    // đối tác
    Route::group(['prefix' => 'support-staff'], function () {
